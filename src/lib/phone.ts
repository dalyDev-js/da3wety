/**
 * Egyptian phone number helpers. Pure and zod-free so client components
 * (WhatsApp share, masked display) can import them without bundling zod.
 * The zod schema lives in lib/validation/phone.ts.
 */
